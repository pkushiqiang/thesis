...
The framework supports three styles to create patterns, which gives developers great flexibility. The most common style is defining pattern expression in a string, which is much like traditional regular expression. We use examples to show how the three styles works:
...
The developers could define their our matcher class to extend the feature of the library.
