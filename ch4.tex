...
In Table \ref{tab:matchers_example}, we give examples of the syntax of these matchers. 
...
We show some patterns used to match degree phases in Table ~\ref{tab:patterns}.
