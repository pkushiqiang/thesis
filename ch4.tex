...
6) In the pattern matching stage, if a layered sentence match any pre-defined pattern with the FST library, the information will be extracted and added to the job model. After every sentence of a job description has be processed, the job model will be saved into the database.
