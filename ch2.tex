...
\begin{enumerate}
    \item  Most systems can only process the structured data of r\'esum\'es and job descriptions, but in reality both them are in un-structured formats, like text files. 
    ...
    \item  In the systems the information fields to matching r\'esum\'es and jobs are coarse-grained. To improve the quality of recommendation,  we need to improve the granularity of information fields and matching algorithm.
